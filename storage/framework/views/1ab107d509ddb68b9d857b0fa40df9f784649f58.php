...
<html lang="en">
	...
	<meta http-equiv="Content-Type" content="text/html; charset=utf8">
        ...
        <link href="<?php echo e(asset('css/social_foundicons.css')); ?>" rel="stylesheet">
        <link href="<?php echo e(asset('css/general_foundicons.css')); ?>" rel="stylesheet">
    </head>
    <body id="page-top">
...
<?php /**PATH /var/www/wyattjohnson/resources/views/layouts/app.blade.php ENDPATH**/ ?>